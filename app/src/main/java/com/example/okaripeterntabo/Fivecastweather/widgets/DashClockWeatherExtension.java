...
import com.example.okaripeterntabo.Fivecastweather.activities.SplashActivity;
...
public class DashClockWeatherExtension extends DashClockExtension {
    private static final Uri URI_BASE = Uri.parse("content://cz.martykan.Fivecastweather.authority");
